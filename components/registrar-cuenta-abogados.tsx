...
export function RegistrarCuentaAbogados() {
  return (
    <>
    ...
    <p className="text-lg text-center mt-2">Complete todos sus datos</p>
          ...
          <form action="#" className="mt-8 space-y-6" method="POST">
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                <Label className="sr-only" htmlFor="cip">
                 Area de especialidad
                </Label>
                <Select name="specialty" required>
                  <SelectTrigger className="aappearance-none text-left rounded-none relative block w-full px-3 py-2 border border-gray-200  placeholder-gray-500 text-gray-500 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                    <SelectValue placeholder="Area de especialidad" />
                  </SelectTrigger>
                  <SelectContent>
